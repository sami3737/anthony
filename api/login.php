...
if ( is_session_started() === FALSE ) session_start();
	if(!$OpenID->mode){
		...
		if(!isset($_SESSION['T2SteamAuth'])){
			$login = "<div id=\"login\">Bienvenue. <br /><br /><br /><a href=\"api/login.php?login\"><img src=\"https://steamcommunity-a.akamaihd.net/public/images/signinthroughsteam/sits_small.png\"/></a></div>";
		}
	}
